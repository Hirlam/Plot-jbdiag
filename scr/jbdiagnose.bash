...
#
# Change accoding to your own model here
# 

F=NAME_OF_YOUR_JB_FILES

cat > namelist << *EOINFILE
 &namjbconv
   gsize_in  =  2500.0,
   nlev_nl   =      65,
...
ln -sf SOME_PATH/$F.bal stabal96.bal
ln -sf SOME_PATH/$F.cv stabal96.cv

rm -rf diag
mkdir diag
src/jbdiagnose.x < namelist || exit 1

mv diag diag_$F
rm -f stabal96.cv stabal96.bal
